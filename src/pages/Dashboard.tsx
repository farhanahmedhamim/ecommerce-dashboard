      ...
      <main className="dashboard">
        ...
        <section className="graphContainer">
          <div className="revenueChart">
            ...
            {/* <!-- graph --> */}
            <BarChart data_1={[200, 444, 343, 556, 778, 455, 990]} data_2={[300, 144, 433, 655, 237, 755, 190]} title_1="Revenue" title_2="Transaction" bgColor_1="rgb(0,115,255)" bgColor_2="rgba(53,162,235,0.8)" />
          </div>
...
interface WidgetItemProps { heading: String, value: number, percent: number, color: string, amount?: boolean };

const WidgetItem = ({ heading, value, percent, color, amount = false }: WidgetItemProps) => <article className="widget">
  <div className="wigrtInfo">
    <p>{heading}</p>
